# Republish Instructions for Version 8.2.0
...
**Expected output:**
```
npm notice 📦  mcp-zebrunner@8.2.0
npm notice === Tarball Details ===
npm notice name:          mcp-zebrunner
npm notice version:       8.2.0
...
+ mcp-zebrunner@8.2.0
```
...
✓ Server io.github.maksimsarychau/mcp-zebrunner version 8.2.0
```
...
git tag -a v8.2.0 -m "Release v8.2.0: MCP Registry publication and comprehensive installation guide"
...
3. Select tag: `v8.2.0`
4. Release title: `v8.2.0 - MCP Registry Publication`
5. Description:
   ```markdown
   ## 🎉 What's New
...
- ✅ npm shows the new version: `npm view mcp-zebrunner version` returns `8.2.0`
- ✅ MCP registry search returns status `"active"` with version `8.2.0`
