# Republish Instructions for Version 6.0.1
...
**Expected output:**
```
npm notice 📦  mcp-zebrunner@6.0.1
...
✓ Server io.github.maksimsarychau/mcp-zebrunner version 6.0.1
```
...
git tag -a v6.0.1 -m "Release v6.0.1: MCP Registry publication and comprehensive installation guide"
...
3. Select tag: `v6.0.1`
4. Release title: `v6.0.1 - MCP Registry Publication`
5. Description:
   ```markdown
   ## 🎉 What's New
...
- ✅ npm shows the new version: `npm view mcp-zebrunner version` returns `6.0.1`
- ✅ MCP registry search returns status `"active"` with version `6.0.1`
