# Republish Instructions for Version 7.2.2
...
**Expected output:**
```
npm notice 📦  mcp-zebrunner@7.2.2
...
✓ Server io.github.maksimsarychau/mcp-zebrunner version 7.2.2
```
...
git tag -a v7.2.2 -m "Release v7.2.2: MCP Registry publication and comprehensive installation guide"
...
3. Select tag: `v7.2.2`
4. Release title: `v7.2.2 - MCP Registry Publication`
5. Description:
   ```markdown
   ## 🎉 What's New
...
- ✅ npm shows the new version: `npm view mcp-zebrunner version` returns `7.2.2`
- ✅ MCP registry search returns status `"active"` with version `7.2.2`
