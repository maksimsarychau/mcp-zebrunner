...
> **Note:** This is a historical implementation record from v4.10.0. The feature is fully shipped and active in the current version. See `analyze_test_screenshots` tool.
