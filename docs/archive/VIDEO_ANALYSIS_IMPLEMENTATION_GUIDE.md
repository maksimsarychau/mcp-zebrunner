...
> **Note:** This is a historical implementation guide. The feature is fully shipped and active in the current version (7.1.1). See `analyze_test_execution_video` tool.
