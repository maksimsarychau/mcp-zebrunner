 ...
 * TCM analytics widgets (37777–37779) route to adv_get_tcm_case_analytics (v9.2.4).
 */
export const WIDGET_EVAL_PROMPTS: EvalPrompt[] = [
  ...
  },
  {
    ...
    toolSection: "18. Dashboard Widgets",
    promptTemplate:
      "Show TCM test case net change over the last 90 days for {{project_key}}, grouped by week — use the TCM case analytics widget.",
  ...
  },
  {
    ...
    toolSection: "18. Dashboard Widgets",
    promptTemplate:
      "Which users updated the most test cases on {{project_key}} in the last 30 days? Use the TCM updated-by-user analytics widget.",
    expectedTools: ["adv_get_tcm_case_analytics"],
    expectedArgKeys: ["project", "mode"],
  ...
  },
  {
    ...
    toolSection: "18. Dashboard Widgets",
    promptTemplate:
      "Show test cases created on {{project_key}} in the last 30 days by author using the TCM created-by-user analytics widget.",
    expectedTools: ["adv_get_tcm_case_analytics"],
    expectedArgKeys: ["project", "mode"],
...

  {
    ...
    toolSection: "18. Dashboard Widgets",
    promptTemplate:
      "What is automation execution ROI (time saved vs manual effort) for {{project_key}} over the last 7 days? Use execution analytics widget.",
  ...
  },
  {
    ...
    toolSection: "18. Dashboard Widgets",
    promptTemplate:
      "Show pass rate broken down by priority for {{project_key}} over {{period}} using bar chart view on the pass-rate-by-period tool.",
    expectedTools: ["adv_get_platform_results_by_period"],
    expectedArgKeys: ["project", "period", "view"],
    category: "analysis",
    layer: 1,
  ...
  },
  {
    ...
    toolSection: "18. Dashboard Widgets",
    promptTemplate:
      "Daily pass and fail trend line for {{project_key}} over {{period}} — pass-rate tool with line view.",
    expectedTools: ["adv_get_platform_results_by_period"],
    expectedArgKeys: ["project", "period", "view"],
    category: "analysis",
    layer: 1,
  ...
  },
  {
    ...
    toolSection: "18. Dashboard Widgets",
    promptTemplate:
      "Tests summary table: passed, failed, and total grouped by build for {{project_key}} over {{period}}. Use pass-rate tool summary view.",
    expectedTools: ["adv_get_platform_results_by_period"],
  ...
  },
  {
    ...
    toolSection: "18. Dashboard Widgets",
    promptTemplate:
      "Which automated tests fell below 99% stability on {{project_key}} in the last 24 hours? Use execution analytics stability_table mode.",
    expectedTools: ["adv_get_execution_analytics"],
    expectedArgKeys: ["project", "mode"],
    forbiddenTools: ["adv_get_platform_results_by_period", "adv_find_flaky_tests"],
    category: "analysis",
    layer: 2,
    requiredContext: ["projectKey"],
  },
  {
    ...
    toolSection: "18. Dashboard Widgets",
    promptTemplate:
      "Combined pass-rate dashboard (pie plus daily trend) for {{project_key}} over {{period}} — pass-rate pie_line view.",
    expectedTools: ["adv_get_platform_results_by_period"],
    expectedArgKeys: ["project", "view"],
    category: "analysis",
    layer: 2,
  ...
  },
  {
    ...
    toolSection: "18. Dashboard Widgets",
    promptTemplate:
      "Calendar heatmap of daily pass rate for {{project_key}} in 2026 Q2 with 75% green threshold — pass-rate calendar view.",
    expectedTools: ["adv_get_platform_results_by_period"],
    expectedArgKeys: ["project", "view"],
    category: "analysis",
    layer: 2,
  ...
  },
  {
    ...
    toolSection: "18. Dashboard Widgets",
    promptTemplate:
      "Daily test execution duration trend for {{project_key}} over the last 7 days — execution analytics duration_trend mode.",
    expectedTools: ["adv_get_execution_analytics"],
    expectedArgKeys: ["project", "mode"],
  ...
  },
  {
    ...
    toolSection: "18. Dashboard Widgets",
    promptTemplate:
      "Failure tag distribution pie for {{project_key}} in the last 24 hours — failure analytics tag_distribution mode.",
  ...
  },
  {
    ...
    toolSection: "18. Dashboard Widgets",
    promptTemplate:
      "Cross-tab of failure tags and maintainers for {{project_key}} today — failure analytics tags_by_maintainer mode.",
    expectedTools: ["adv_get_failure_analytics"],
    expectedArgKeys: ["project", "mode"],
    category: "analysis",
    layer: 1,
  ...
  },
  {
    ...
    toolSection: "18. Dashboard Widgets",
    promptTemplate:
      "Map Jira issues to maintainers by failure count on {{project_key}} for the last 14 days — failure analytics jira_by_maintainer mode.",
    expectedTools: ["adv_get_failure_analytics"],
    expectedArgKeys: ["project", "mode"],
    category: "analysis",
    layer: 1,
  ...
  },
  {
    ...
    toolSection: "18. Dashboard Widgets",
    promptTemplate:
      "Launch duration trend for suite {{suite_name}} on {{project_key}} this quarter — execution analytics launch_duration mode.",
    expectedTools: ["adv_get_execution_analytics"],
    expectedArgKeys: ["project", "mode"],
...

  {
    ...
    toolSection: "18. Dashboard Widgets",
    promptTemplate:
      "Execution ROI widget for {{project_key}} last 7 days — use execution analytics, NOT the TCM distribution-by-field pie tool.",
    expectedTools: ["adv_get_execution_analytics"],
    forbiddenTools: ["adv_get_test_case_distribution_by_field"],
    category: "negative",
    layer: 2,
  ...
  },
  {
    ...
    toolSection: "18. Dashboard Widgets",
    promptTemplate:
      "Low stability tests table (below 99%) for {{project_key}} — execution analytics stability_table, NOT pass-rate-by-period.",
    expectedTools: ["adv_get_execution_analytics"],
  ...
  },
  {
    ...
    toolSection: "18. Dashboard Widgets",
    promptTemplate:
      "Failure tag pie for {{project_key}} — failure analytics tag_distribution, not TCM case distribution.",
    expectedTools: ["adv_get_failure_analytics"],
    forbiddenTools: ["adv_get_test_case_distribution_by_field"],
    category: "negative",
    layer: 1,
