...
const CLOUD_EVAL_PROMPT_IDS = [
  ...
  "field_history.with_transition_args",
  "field_history.build_continue",
  "field_history.single_case_audit",
  "field_history.distribution_case_status",
  "field_history.neg.not_field_filter",
  "field_history.neg.not_distribution",
  "field_history.neg.not_advanced_scan",
