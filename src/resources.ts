    ...
    servers: [
      ...
      },
      {
        ...
        best_for: [
          ...
          "Preview/confirm safe mutations (adv_create_test_case, adv_update_test_case, adv_manage_test_run, adv_import_launch_results_to_test_run, adv_rerun_launch_failures)",
